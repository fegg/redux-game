...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	function coordinates() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? [1, 1] : arguments[0];
	    var action = arguments[1];

	    switch (action.type) {
	        case CLICK:
	            return [state[0] + 40 * Math.random(), state[1] + 40 * Math.random()];
	        default:
	            return state;
	    }
	}
	...
	*/
	var store = (0, _redux.createStore)(coordinates);
	...
	function create() {
	    ...
	    var plane = game.add.sprite(store.getState()[0], store.getState()[1], 'plane');
